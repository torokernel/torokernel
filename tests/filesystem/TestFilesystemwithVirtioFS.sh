...
/home/ubuntu/binutils-2.26.1/ld/ld-new -melf_i386 -T ../../builder/link_start64.ld -T kernel64.symbols kernel64.o -o $app.bin
sudo ~/qemu/build/x86_64-softmmu/qemu-system-x86_64 --enable-kvm -kernel $appbin $qemuparams
