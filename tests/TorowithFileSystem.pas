...
{$IFDEF WIN64}
          {%RunCommand qemu-system-x86_64.exe -m 512 -smp 2 -drive format=raw,file=TorowithFileSystem.img -drive format=raw,file=ToroTest.img -serial file:torodebug.txt}
{$ELSE}
